        ...
        with st.container():
            with st.form("entry_form", clear_on_submit=True):
                    ...
                    if st.form_submit_button("Cadastrar"):
                        if contagem_blocos_respondidos == 4:
                            controller_usuario.inserir_usuario(User(st.session_state["id_input"],st.session_state["name_input"],st.session_state["email_input"],st.session_state["password_input"]))
